	...
	$.extend({
		simpleWeather: function(options){
			...
			if (options.lat != null && options.lng != null) {
				weatherUrl += 'select * from weather.forecast where woeid in (SELECT woeid FROM geo.placefinder WHERE text="'+options.lat+','+options.lng+'" AND gflags="R") and u="'+options.unit+'"';
